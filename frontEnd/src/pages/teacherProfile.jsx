...
import NavBar from "../componrnts/navs/NavTeacher";
...
const TeacherProfile = () => {
  ...
  const fetchTeacherData = () => {
    if (!isAuthenticated() || isAuthenticated().userType !== "teacher") {
      navigate("/login");
    }
    ...
    <>
      ...
      <div className="body">
        <div className="container">
          <h1 style={{ color: "#16df70" }}>Teacher Profile</h1>
          ...
          {loading ? (
            ...
            <form onSubmit={handleSubmit} className="App">
              ...
              />
              <p>
              <a style={{color: "rgb(22,223,112)"}} href="/change-password">Change Password</a>
              </p>
